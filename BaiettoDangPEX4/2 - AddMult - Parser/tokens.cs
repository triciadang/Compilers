...
public sealed class TExponential : Token
{
    public TExponential(string text)
    {
        Text = text;
    }

    public TExponential(string text, int line, int pos)
    {
        Text = text;
        Line = line;
        Pos = pos;
    ...
    public override Object Clone()
    {
      return new TExponential(Text, Line, Pos);
    }

    public override void Apply(Switch sw)
    {
        ((Analysis) sw).CaseTExponential(this);
    }
}
